<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Collection.aspx.cs" Inherits="EVident.Collection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="server">
    ...
    <asp:EntityDataSource ID="kpoDataSource" runat="server" 
        ...
        Where="it.WasteRecordCard.Id == @WasteRecordCardId &amp;&amp; it.Kind == 2" 
    ...
    <asp:EntityDataSource ID="wasteRecordCardElementWithoutKPODataSource" runat="server" 
        ...
        Where="it.WasteRecordCard.Id == @WasteRecordCardId &amp;&amp; it.Kind == 2 &amp;&amp; it.WasteTransferCard is null" 
        Select="" >
        <WhereParameters>
            <asp:QueryStringParameter DbType="Int64" Name="WasteRecordCardId" 
                QueryStringField="WasteRecordCardId" />
        ...
        <asp:ListView ID="wasteRecordCardElementListView" runat="server" DataKeyNames="Id" 
            ...
            <EditItemTemplate>
                <tr>
                    ...
                    <td class="aligntopcenter">
                        <asp:TextBox ID="ReceivedDryMassTextBox" runat="server" 
                            Text='<%# Bind("ReceivedDryMass") %>' CssClass="smallTextBox" />
                        <asp:RequiredFieldValidator ID="ReceivedDryMassRequiredFieldValidator" runat="server" ControlToValidate="ReceivedDryMassTextBox" 
                            ValidationGroup="UPDATE_2ND" ErrorMessage="* nie podano wartości" Display="Dynamic" />
                        <asp:RegularExpressionValidator ID="ReceivedDryMassRegularExpressionValidator" Display="Dynamic" ErrorMessage="* podano błędną liczbę" 
	                        ValidationGroup="UPDATE_2ND" ControlToValidate="ReceivedDryMassTextBox" ValidationExpression="^\d+(,\d+)?$" runat="server" />
                    </td>
                    <td class="aligntop">
                        <asp:LinkButton ID="UpdateButton" runat="server" CommandName="Update" 
                ...
                <tr>
                    ...
                    <td class="aligntop">
                        ...
                        <asp:RequiredFieldValidator ID="ReceivedDryMassRequiredFieldValidator" runat="server" ControlToValidate="ReceivedDryMassTextBox" 
                            ValidationGroup="INSERT_2ND" ErrorMessage="* nie podano wartości" Display="Dynamic" />
                        <asp:RegularExpressionValidator ID="ReceivedDryMassRegularExpressionValidator" Display="Dynamic" ErrorMessage="* podano błędną liczbę" 
	                        ValidationGroup="INSERT_2ND" ControlToValidate="ReceivedDryMassTextBox" ValidationExpression="^\d+(,\d+)?$" runat="server" />
                    </td>
                    <td class="aligntop">
                        <asp:Button ID="InsertButton" runat="server" CommandName="Insert"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="aligntop">
                        <asp:Label ID="ReceivedDryMassLabel" runat="server" 
                            Text='<%# (Eval("ReceivedDryMass") + "") != "0" ? Eval("ReceivedDryMass", "{0:F4}") : "---" %>' />
                    </td>
                    <td class="aligntop">
                        <asp:LinkButton ID="EditButton" runat="server" CommandName="Edit" Text="Edytuj" />&nbsp;
                        <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Delete" 
        ...
        <asp:ListView ID="collectionWithoutKPOListView" runat="server" DataKeyNames="Id" 
            ...
            <EditItemTemplate>
                <tr>
                    ...
                    <td class="aligntop">
                        <asp:TextBox ID="ReceivedDryMassTextBox3" runat="server" 
                            Text='<%# Bind("ReceivedDryMass") %>' CssClass="smallTextBox" />
                        <asp:RequiredFieldValidator ID="ReceivedDryMassRequiredFieldValidator3" runat="server" ControlToValidate="ReceivedDryMassTextBox3" 
                            ValidationGroup="UPDATE_3RD" ErrorMessage="* nie podano wartości" Display="Dynamic" />
                        <asp:RegularExpressionValidator ID="ReceivedDryMassRegularExpressionValidator3" Display="Dynamic" ErrorMessage="* podano błędną liczbę" 
	                        ValidationGroup="UPDATE_3RD" ControlToValidate="ReceivedDryMassTextBox3" ValidationExpression="^\d+(,\d+)?$" runat="server" />
                    </td>
                    <td class="aligntop">
                        <asp:LinkButton ID="UpdateButton" runat="server" CommandName="Update" 
            ...
            <InsertItemTemplate>
                <tr>
                    ...
                    <td class="aligntop">
                        ...
                        <asp:TextBox ID="ReceivedDryMassTextBox2" runat="server" 
                                     Text='<%# Bind("ReceivedDryMass") %>' CssClass="smallTextBox" />
                        <asp:RequiredFieldValidator ID="ReceivedDryMassRequiredFieldValidator2" runat="server" ControlToValidate="ReceivedDryMassTextBox2" 
                            ValidationGroup="INSERT_3RD" ErrorMessage="* nie podano wartości" Display="Dynamic" />
                        <asp:RegularExpressionValidator ID="ReceivedDryMassRegularExpressionValidator2" Display="Dynamic" ErrorMessage="* podano błędną liczbę" 
	                        ValidationGroup="INSERT_3RD" ControlToValidate="ReceivedDryMassTextBox2" ValidationExpression="^\d+(,\d+)?$" runat="server" />
                    </td>
                    <td class="aligntop">
                        <asp:Button ID="InsertButton" runat="server" CommandName="Insert"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="aligntop">
                        <asp:Label ID="ReceivedDryMassLabel" runat="server" 
                            Text='<%# Math.Abs(Double.Parse(Eval("ReceivedDryMass") + "") - 0) > 0.00001 ? Eval("ReceivedDryMass","{0:F4}") : "---" %>' />
                    </td>
                    <td class="aligntop">
                        <asp:LinkButton ID="EditButton" runat="server" CommandName="Edit" Text="Edytuj" />&nbsp;
                        <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Delete" 
