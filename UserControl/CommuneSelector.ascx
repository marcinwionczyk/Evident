...
<usr:DropDownListExtended ID="communeDropDownList" runat="server" 
    CssClass="smallDropDownList"
    DataTextField="Name" DataValueField="Id" />
<asp:RequiredFieldValidator ID="communeRequiredFieldValidator" ControlToValidate="communeDropDownList"
    runat="server" ErrorMessage="* nie wybrano wartości" Display="Dynamic" />
