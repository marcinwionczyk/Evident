...
namespace EVident.UserControl
{
    public partial class CommuneSelector : System.Web.UI.UserControl
    {
        ...
        public bool InsertEmptyCommune { get; set; }

        public string ValidationGroup
        {
            get { return communeRequiredFieldValidator.ValidationGroup; }
            set { communeRequiredFieldValidator.ValidationGroup = value; }
        }
        ...
        public bool Enabled
        {
            get
            {
                return communeDropDownList.Enabled &&
                    ...
                    communeRequiredFieldValidator.Enabled;
            }
            ...
            set
            {
                ...
                communeRequiredFieldValidator.Enabled = value;
            }
        }
        ...
        private void SelectCommuneDistrictProvince(Commune commune)
        {
            ...
            else communeDropDownList.SelectedValue = "";
        }
